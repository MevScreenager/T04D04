...
> корректную работу с памятью и проверяться статическим анализатором кода. Перед  отправкой решений, можно протестировать
...
***== Получен Quest 1. Создать программу src/1948.c, которая находит наибольший простой делитель заданного целого числа `a`. Использовать деление и операцию взятия остатка от деления нельзя. В случае ошибки вывести "n/a". ==***
